...
import type { UpdateIntegrationResponseRequest, UpdateIntegrationResponseResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateIntegrationResponseCommand_base: {
    new (input: UpdateIntegrationResponseCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateIntegrationResponseCommandInput, UpdateIntegrationResponseCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateIntegrationResponseCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateIntegrationResponseCommandInput, UpdateIntegrationResponseCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;

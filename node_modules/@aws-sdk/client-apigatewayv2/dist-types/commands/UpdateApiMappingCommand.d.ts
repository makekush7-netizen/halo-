...
import type { UpdateApiMappingRequest, UpdateApiMappingResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateApiMappingCommand_base: {
    new (input: UpdateApiMappingCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateApiMappingCommandInput, UpdateApiMappingCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateApiMappingCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateApiMappingCommandInput, UpdateApiMappingCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;

...
import type { UpdateModelRequest, UpdateModelResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateModelCommand_base: {
    new (input: UpdateModelCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateModelCommandInput, UpdateModelCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateModelCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateModelCommandInput, UpdateModelCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;

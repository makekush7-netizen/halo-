...
import type { UpdateDeploymentRequest, UpdateDeploymentResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateDeploymentCommand_base: {
    new (input: UpdateDeploymentCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDeploymentCommandInput, UpdateDeploymentCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateDeploymentCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDeploymentCommandInput, UpdateDeploymentCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;

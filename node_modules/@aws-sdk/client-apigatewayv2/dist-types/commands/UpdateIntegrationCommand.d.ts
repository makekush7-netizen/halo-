...
import type { UpdateIntegrationRequest, UpdateIntegrationResult } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateIntegrationCommand_base: {
    new (input: UpdateIntegrationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateIntegrationCommandInput, UpdateIntegrationCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateIntegrationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateIntegrationCommandInput, UpdateIntegrationCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;

...
import type { UpdateRouteResponseRequest, UpdateRouteResponseResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateRouteResponseCommand_base: {
    new (input: UpdateRouteResponseCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRouteResponseCommandInput, UpdateRouteResponseCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateRouteResponseCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRouteResponseCommandInput, UpdateRouteResponseCommandOutput, ApiGatewayV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
